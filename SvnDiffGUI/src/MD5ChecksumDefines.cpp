...
std::string CMD5Checksum::md5file(const char* filename){
...
std::string CMD5Checksum::md5file(FILE* file){
...
std::string CMD5Checksum::md5(const void* dat, size_t len) {
	string res;
	unsigned char out[16];
	md5bin(dat, len, out);
	for (size_t i = 0; i < 16; ++i) {
...
std::string CMD5Checksum::md5(std::string dat){
...
std::string CMD5Checksum::md5sum6(const void* dat, size_t len){
...
std::string CMD5Checksum::md5sum6(std::string dat){
